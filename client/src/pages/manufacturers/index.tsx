...
import { ManufacturerFormDialog } from "./form-dialog";
...
export default function ManufacturersPage() {
  ...
  const deleteMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      toast({ title: "Montadora excluída com sucesso" });
      setDeleteId(null);
    },
    onError: () => {
      toast({ title: "Erro ao excluir montadora", variant: "destructive" });
    },
  });
  ...
  const columns = [
    ...
    { key: "contactName", label: "Contato" },
    {
      ...
      render: (m: Manufacturer) => (
        <Badge variant={m.isActive === "true" ? "default" : "secondary"}>
          {m.isActive === "true" ? "Ativo" : "Inativo"}
        </Badge>
      ),
    },
    {
    ...
    <div className="flex flex-col">
      ...
      <div className="flex-1 overflow-auto p-4 md:p-6">
        <div className="mb-4 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          ...
          <Button onClick={handleNew} data-testid="button-add-manufacturer">
        ...
        <DataTable
          ...
          emptyMessage="Nenhuma montadora cadastrada"
        />
      </div>
      ...
      <AlertDialog open={!!deleteId} onOpenChange={() => setDeleteId(null)}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Tem certeza que deseja excluir esta montadora? Esta ação não pode ser desfeita.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
